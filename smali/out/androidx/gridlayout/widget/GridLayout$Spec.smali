...
.method constructor <init>(ZIILandroidx/gridlayout/widget/GridLayout$Alignment;F)V
    ...
    .param p2, "start"    # I
    .param p3, "size"    # I
    .param p4, "alignment"    # Landroidx/gridlayout/widget/GridLayout$Alignment;
    .param p5, "weight"    # F
    ...
    invoke-direct {v0, p2, v1}, Landroidx/gridlayout/widget/GridLayout$Interval;-><init>(II)V
...
.method private constructor <init>(ZLandroidx/gridlayout/widget/GridLayout$Interval;Landroidx/gridlayout/widget/GridLayout$Alignment;F)V
    .registers 5
    .param p1, "startDefined"    # Z
    .param p2, "span"    # Landroidx/gridlayout/widget/GridLayout$Interval;
    .param p3, "alignment"    # Landroidx/gridlayout/widget/GridLayout$Alignment;
    .param p4, "weight"    # F
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroidx/gridlayout/widget/GridLayout$Spec;

    .line 2492
    .local v2, "spec":Landroidx/gridlayout/widget/GridLayout$Spec;
    iget-object v3, p0, Landroidx/gridlayout/widget/GridLayout$Spec;->alignment:Landroidx/gridlayout/widget/GridLayout$Alignment;

    iget-object v4, v2, Landroidx/gridlayout/widget/GridLayout$Spec;->alignment:Landroidx/gridlayout/widget/GridLayout$Alignment;
    ...
    .line 2496
    :cond_20
    iget-object v3, p0, Landroidx/gridlayout/widget/GridLayout$Spec;->span:Landroidx/gridlayout/widget/GridLayout$Interval;

    iget-object v4, v2, Landroidx/gridlayout/widget/GridLayout$Spec;->span:Landroidx/gridlayout/widget/GridLayout$Interval;

    invoke-virtual {v3, v4}, Landroidx/gridlayout/widget/GridLayout$Interval;->equals(Ljava/lang/Object;)Z
    ...
    .line 2487
    .end local v2    # "spec":Landroidx/gridlayout/widget/GridLayout$Spec;
    :cond_2c
    :goto_2c
    return v1
.end method
...
.method public getAbsoluteAlignment(Z)Landroidx/gridlayout/widget/GridLayout$Alignment;
    ...
    :cond_15
    sget-object v0, Landroidx/gridlayout/widget/GridLayout;->BASELINE:Landroidx/gridlayout/widget/GridLayout$Alignment;
    ...
    .line 2456
    :cond_18
    sget-object v0, Landroidx/gridlayout/widget/GridLayout;->FILL:Landroidx/gridlayout/widget/GridLayout$Alignment;
